...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            ...
            <%
                Map<Integer, Debtor> searchMapRetrieved = (Map<Integer, Debtor>)request.getAttribute("searchMapResults");
            %>
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <form action="deleteMultipleController" method="post">
                                            ...
                                            <%  
                                            for (Integer number : searchMapRetrieved.keySet()) {
                                                out.print("<tr>");
                                                Debtor debtor = searchMapRetrieved.get(number);
                                                ...
                                                out.print("<td><a href='edit.jsp?serial="+number+"&status=search'>Edit</a></td>");
                                            ...
                                            <a href="userMGMT.jsp"><input class="btn btn-info btn-fill" type="button" name="clear"  value="Clear" style="margin-left:10px;"/></a>
